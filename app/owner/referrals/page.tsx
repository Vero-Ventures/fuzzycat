...
export default function OwnerReferralsPage() {
  ...
  const { data: codeData } = useQuery(trpc.growth.getMyOwnerReferralCode.queryOptions());
  const { data: referrals } = useQuery(trpc.growth.getMyOwnerReferrals.queryOptions());
    ...
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">
          Share FuzzyCat with other pet owners. You both save on platform fees.
        </p>
      </div>
          ...
          <CardContent>
            {!referrals || referrals.length === 0 ? (
              ...
              <Table>
                ...
                <TableBody>
                  {referrals.map((ref: OwnerReferralRow) => (
                    <TableRow key={ref.id}>
